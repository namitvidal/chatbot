  ...
  insertNavigation() {
    ...
    if (this.navigationContainer === null) {
      this.navigationContainer = this.drawerr.insertAdjacentHTML(
        'afterbegin',
        `<div class="${this.multilevelSettings.navigationContainerClass
        }"></div>`
      )
    ...
    this.navigationContainer.insertAdjacentHTML(
      'afterbegin',
      ` <a tabIndex="-1" class="${this.multilevelSettings.navigationTextClass
      }" href="#"><span class="${this.multilevelSettings.navigationTextClass
      }__icon ${this.multilevelSettings.hiddenClass}"></span><span class="${this.multilevelSettings.navigationTextClass
